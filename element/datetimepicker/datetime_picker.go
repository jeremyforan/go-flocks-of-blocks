...
func NewDateTimePicker(actionId string) DateTimePicker {
	return DateTimePicker{
		slackType: element.DateTimePicker,
		actionId:  actionId,
		options: dateTimePickerOptions{
...
func (d *DateTimePicker) setConfirm(confirm confirmationdialog.ConfirmationDialog) {
	d.confirm = confirm
...
func (d DateTimePicker) AddConfirmationDialog(confirm confirmationdialog.ConfirmationDialog) DateTimePicker {
