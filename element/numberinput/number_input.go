...
func (n *NumberInput) setDispatchActionConfig(dispatchActionConfig dispatchactionconfig.DispatchActionConfig) {
...
func (n NumberInput) DispatchAction(dispatchActionConfig dispatchactionconfig.DispatchActionConfig) NumberInput {
...
func (n *NumberInput) setPlaceholder(placeholder string) {
	n.placeholder = compositiontext.NewPlainText(placeholder)
