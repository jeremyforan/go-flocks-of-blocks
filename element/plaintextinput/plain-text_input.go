...
func NewPlainTextInput(actionId string) PlainTextInput {
	return PlainTextInput{
		slackType: element.PlainTextInput,
		actionID:  actionId,
		optionals: plainTextInputOptions{
			InitialValue:         false,
			Multiline:            false,
...
func (m *PlainTextInput) setDispatchActionConfig(dispatchActionConfig dispatchactionconfig.DispatchActionConfig) {
...
func (m *PlainTextInput) removeDispatchActionConfig() {
	m.dispatchActionConfig = dispatchactionconfig.DispatchActionConfig{}
	m.optionals.DispatchActionConfig = false
}

// AddDispatchActionConfig public update dispatch action config
func (m PlainTextInput) AddDispatchActionConfig(dispatchActionConfig dispatchactionconfig.DispatchActionConfig) PlainTextInput {
